  ...
  <div class="landing-page">
        ...
        <div class="flex items-center pt-10 px-5 md:px-0">
          <div class="w-1/2">
            <h1 class="text-4xl text-white mb-5">
              We People <u class="hero-underline">owner and finder</u> to <br />
              getting started with<u class="hero-underline">room</u> <br />
              to live
            </h1>
            <p class="text-white text-xl font-light mb-8">
              Find The Best The Best ROOM <br />
              For Live and Stay
            </p>
            <button
    ...
    <section class="container mx-auto pt-24">
      <div class="flex justify-between items-center">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            New Rooms you can <br />
            taken stay of
          </h2>
        </div>
        <div class="w-auto mt-5">
          <nuxt-link
            class="text-gray-900 h-15 hover:underline text-md font-medium"
            to=""
            >View All</nuxt-link
          >
        </div>
            ...
            <div class="item-meta">
              ...
              <div class="relative pt-4">
                <div
                  ...
                  "
                ></div>
                <div class="ml-auto font-semibold">Rp. {{ new Intl.NumberFormat().format(kost.price)}}</div>
              </div>
            </div>
            <button
              @click="$router.push({name: 'rooms-id', params: {id: kost.id}})"
              class="
                text-center
                mt-5
                button-cta
...
export default {
  async asyncData({ $axios }) {
    const kosts = await $axios.$get('/api/v1/kosts')
    return { kosts }
  },
}
</script>
